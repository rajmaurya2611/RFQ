...
//     try {
//       await navigator.clipboard.writeText(text);
//       // Optionally, you can show a notification or console message
//       console.log("Text copied to clipboard");
//     } catch (err) {
//       console.error("Failed to copy text: ", err);
//     }
...
//   return (
//     <div className="relative flex-grow overflow-hidden bg-transparent p-4">
//       {/* Chat container with beams and animation */}
//       <div className="relative w-full h-full rounded-md overflow-hidden">
//         {/* Background beams */}
//         <div className="fixed inset-0 z-0">
//           <BackgroundBeams className="w-full h-full text-primary opacity-80" />
...
//         <iframe
//           src="https://lottie.host/embed/c1015797-67d7-4a90-9c01-4a1f2ae91bc9/M7xF5lhe9b.lottie"
//           style={{
//             position: 'fixed',
//             top: '50%',
//             left: '50%',
...
//             pointerEvents: 'none',
//           }}
//           title="Lottie Animation Background"
//         ></iframe>
...
//                 {/* Optional timestamp
//                 {message.timestamp && (
//                   <small className="text-gray-500 mt-2">{message.timestamp}</small>
//                 )} */}

//                 {/* Action buttons: Speaker and Copy */}
//                 <div className="flex gap-2 mt-1 self-end">
//                   <button
//                     onClick={() => speakText(message.text)}
//                     className="p-1 hover:bg-gray-300 rounded"

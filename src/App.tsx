...
export default function App() {
  ...
  // Selected Model state ("word or pdf")
  const [selectedModel, setSelectedModel]=useState("word");
  ...
  const handleSend = async (message: string) => {
    ...
    try {
      const botReply = await getChatbotResponse(message,selectedModel);
      let index = 0;
    ...
    <div className="flex flex-col h-screen bg-white text-black">
      ...
      <div className="p-4">
        <PlaceholdersAndVanishInput 
          placeholders={["Hello I am RFQ Bot!", "Choose Interaction Model and ask something"]}
          onSubmit={(e) => {
            e.preventDefault();
